...
wrap_function_in_namespace
  ...
  it 'returnerar [8, 0, 5] till input ([8, 2, 0, 2, 5], 2)' do
    StudentMethods.send(FUNCTION, [8, 2, 0, 2, 5], 2).must_equal [8, 0, 5]
  end
  
  it 'returnerar [8, 2, 0, 2, 5] till input ([8, 2, 0, 2, 5], "2")' do
    StudentMethods.send(FUNCTION, [8, 2, 0, 2, 5], "2").must_equal [8, 2, 0, 2, 5]
  end

  it 'returnerar ["bosse", "kalle"] till input (["bosse", "olof", "olof", "kalle", "olof"], "olof")' do
    StudentMethods.send(FUNCTION, ["bosse", "olof", "olof", "kalle", "olof"], "olof").must_equal ["bosse", "kalle"]
  end
