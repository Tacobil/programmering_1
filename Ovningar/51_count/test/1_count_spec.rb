...
wrap_function_in_namespace
  ...
  it 'Använder inte ".count"' do
    require_relative RELATIVE_PATH
    Array.any_instance.expects(:count).never
    StudentMethods.send(FUNCTION, [1, 2, 3, 4, 5], 1)
  end


  it 'returnerar 3 till input (["ketchup", "ketchup", "senap", "ketchup"],"ketchup")' do
    StudentMethods.send(FUNCTION, ["ketchup", "ketchup", "senap", "ketchup"],"ketchup").must_equal 3
  end

  it 'returnerar 0 till input ([2,1,0,88,93], 5)' do
    StudentMethods.send(FUNCTION, [2,1,0,88,93], 5).must_equal 0
  end

  it 'returnerar 4 till input ([8, 2, 0, 2, 5, 0, 0, 0], 0)' do
    StudentMethods.send(FUNCTION, [8, 2, 0, 2, 5, 0, 0, 0], 0).must_equal 4
  end

  it 'returnerar 0 till input (["ketchup", "ketchup", "senap", "ketchup"],"Ketchup")' do
    StudentMethods.send(FUNCTION, ["ketchup", "ketchup", "senap", "ketchup"],"Ketchup").must_equal 0
  end
