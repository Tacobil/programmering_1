...
wrap_function_in_namespace
  ...
  it 'Modifierar den ursprungliga arrayen (in-place)' do
    test_array = [5, 3, 8, 4, 2]
    result = StudentMethods.send(FUNCTION, test_array)
    assert_equal [2, 3, 4, 5, 8], test_array, "Den ursprungliga arrayen ska vara modifierad"
    assert_equal test_array.object_id, result.object_id, "Funktionen ska returnera samma array-objekt"
  end
